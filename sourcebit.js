        ...
        },
        {
            ...
            options: {
                ...
                pages: [
                    ...
                    { path: '/{stackbit_url_path}', predicate: _.matchesProperty('__metadata.modelName', 'article') },
                ...
                commonProps: (items) => {
                    return {
                        pages: _.filter(items, item => ["advanced","article","page","post"].includes(_.get(item, '__metadata.modelName'))),
                        data: {
