        ...
        },
        {
            ...
            options: {
                ...
                pages: [
                    ...
                    { path: '/{stackbit_url_path}', predicate: _.matchesProperty('__metadata.modelName', 'articles') },
                ...
                commonProps: (items) => {
                    return {
                        pages: _.filter(items, item => ["advanced","articles","page","post"].includes(_.get(item, '__metadata.modelName'))),
                        data: {
